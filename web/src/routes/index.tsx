...
function QueryAnswerSection({ answer }: { answer: string }) {
	const blocks = parseAnswerMarkdown(answer);
	const fallback = normalizeAnswerText(answer);

	return (
		<section className="feature-card mb-4 overflow-hidden rounded-2xl border border-[var(--line)]">
			...
			<div className="max-h-[40vh] space-y-2 overflow-y-auto bg-[var(--surface-strong)]/80 px-4 py-3">
				{blocks.length === 0 ? (
